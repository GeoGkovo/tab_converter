...
var _process_data = Module['_process_data'] = makeInvalidEarlyAccess('_process_data');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['process_data'] != 'undefined', 'missing Wasm export: process_data');
  _process_data = Module['_process_data'] = createExportWrapper('process_data', 5);
